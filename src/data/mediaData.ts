...
export const tvShowsData: Record<Language, TVShow[]> = {
  English: [
    ...
    { name: "Normal People", genre: ["Drama", "Romance"], yearRange: "2020", seasons: 1, language: "English", platform: "Hotstar", status: "Watched" },
    { name: "The Queen's Gambit", genre: ["Drama"], yearRange: "2020", seasons: 1, language: "English", platform: "Netflix", status: "Watched" },
    { name: "Avatar: The Last Airbender", genre: ["Fantasy", "Action", "Drama"], yearRange: "2005-2008", seasons: 3, language: "English", platform: "Netflix", status: "Watched" },
    { name: "Mr. Robot", genre: ["Drama", "Thriller", "Sci-Fi"], yearRange: "2015-2019", seasons: 4, language: "English", platform: "Prime", status: "Watched" },
    { name: "The Pitt", genre: ["Medical", "Drama"], yearRange: "2025-Present", seasons: 2, language: "English", platform: "HBO", status: "Watched" },
    { name: "House M.D.", genre: ["Medical", "Drama", "Mystery"], yearRange: "2004-2012", seasons: 8, language: "English", platform: "Netflix", status: "Watched" },
    { name: "The Bear", genre: ["Comedy", "Drama"], yearRange: "2022-Present", seasons: 4, language: "English", platform: "Disney+", status: "Watched" },
    { name: "Ted Lasso", genre: ["Comedy", "Drama", "Sports"], yearRange: "2020-Present", seasons: 3, language: "English", platform: "Apple TV+", status: "Watched" },
    { name: "Brooklyn Nine-Nine", genre: ["Comedy", "Crime"], yearRange: "2013-2021", seasons: 8, language: "English", platform: "Netflix", status: "Watched" },
    { name: "Sherlock", genre: ["Mystery", "Crime", "Drama"], yearRange: "2010-2017", seasons: 4, language: "English", platform: "Netflix", status: "Watched" },
    { name: "Fleabag", genre: ["Comedy", "Drama"], yearRange: "2016-2019", seasons: 2, language: "English", platform: "Prime", status: "Watched" },
    { name: "Seinfeld", genre: ["Comedy"], yearRange: "1989-1998", seasons: 9, language: "English", platform: "Netflix", status: "Watched" },
  ...
  Hindi: [
    { name: "Farzi", genre: ["Crime", "Comedy", "Thriller"], yearRange: "2023", seasons: 1, language: "Hindi", platform: "Prime", status: "Watched" },
    { name: "Asur", genre: ["Crime", "Thriller", "Mystery"], yearRange: "2020-2023", seasons: 2, language: "Hindi", platform: "Hotstar", status: "Watched" },
    { name: "Made in Heaven", genre: ["Drama", "Romance"], yearRange: "2019-2023", seasons: 2, language: "Hindi", platform: "Prime", status: "Watched" },
    { name: "Special Ops", genre: ["Action", "Thriller"], yearRange: "2020-2025", seasons: 2, language: "Hindi", platform: "Hotstar", status: "Watched" },
    { name: "Aspirants", genre: ["Drama", "Comedy"], yearRange: "2021-2023", seasons: 2, language: "Hindi", platform: "Prime", status: "Watched" },
  ...
  Korean: [
    { name: "Kill Me, Heal Me", genre: ["Romance", "Mystery", "Drama"], yearRange: "2015", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Reborn Rich", genre: ["Fantasy", "Drama"], yearRange: "2022", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Designated Survivor: 60 Days", genre: ["Political", "Thriller", "Drama"], yearRange: "2019", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Chief of Staff", genre: ["Political", "Drama"], yearRange: "2019", seasons: 2, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Doctor Prisoner", genre: ["Thriller", "Crime", "Medical"], yearRange: "2019", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Strong Woman Do Bong-soon", genre: ["Action", "Comedy", "Romance"], yearRange: "2017", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Prison Playbook", genre: ["Comedy", "Drama", "Crime"], yearRange: "2017-2018", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Weak Hero Class 2", genre: ["Thriller", "Drama", "Action"], yearRange: "2025", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "The Trauma Code: Heroes on Call", genre: ["Medical", "Action", "Drama"], yearRange: "2025", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Daily Dose of Sunshine", genre: ["Medical", "Drama"], yearRange: "2023", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Happiness", genre: ["Thriller", "Drama", "Sci-Fi"], yearRange: "2021", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Queen of Tears", genre: ["Romance", "Comedy", "Drama"], yearRange: "2024", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "A Killer Paradox", genre: ["Crime", "Thriller", "Mystery"], yearRange: "2024", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Mask Girl", genre: ["Crime", "Thriller", "Drama"], yearRange: "2023", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "While You Were Sleeping", genre: ["Fantasy", "Romance", "Legal"], yearRange: "2017", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "W: Two Worlds", genre: ["Fantasy", "Romance", "Thriller"], yearRange: "2016", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Fight for My Way", genre: ["Romance", "Comedy", "Drama"], yearRange: "2017", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Live", genre: ["Crime", "Drama", "Comedy"], yearRange: "2018", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Through the Darkness", genre: ["Crime", "Mystery", "Drama"], yearRange: "2022", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "The Devil Judge", genre: ["Legal", "Thriller", "Sci-Fi"], yearRange: "2021", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "City Hunter", genre: ["Action", "Romance", "Thriller"], yearRange: "2011", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Healer", genre: ["Action", "Romance", "Mystery"], yearRange: "2014-2015", seasons: 1, language: "Korean", platform: "Other", status: "Watched" },
    { name: "Big Mouth", genre: ["Legal", "Crime", "Thriller"], yearRange: "2022", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Little Women", genre: ["Mystery", "Thriller", "Drama"], yearRange: "2022", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Juvenile Justice", genre: ["Legal", "Crime", "Drama"], yearRange: "2022", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Law School", genre: ["Legal", "Crime", "Mystery"], yearRange: "2021", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Hyena", genre: ["Legal", "Mystery", "Romance"], yearRange: "2020", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Search: WWW", genre: ["Drama", "Romance"], yearRange: "2019", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Start-Up", genre: ["Romance", "Drama", "Comedy"], yearRange: "2020", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Descendants of the Sun", genre: ["Romance", "Action", "Drama"], yearRange: "2016", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Itaewon Class", genre: ["Drama", "Romance", "Comedy"], yearRange: "2020", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Hellbound", genre: ["Horror", "Thriller", "Fantasy"], yearRange: "2021-2024", seasons: 2, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Sweet Home", genre: ["Horror", "Thriller", "Drama"], yearRange: "2020-2024", seasons: 3, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "The Uncanny Counter", genre: ["Fantasy", "Action", "Thriller"], yearRange: "2020-2023", seasons: 2, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "One Spring Night", genre: ["Romance", "Drama"], yearRange: "2019", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Run On", genre: ["Romance", "Comedy", "Drama"], yearRange: "2020-2021", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Voice", genre: ["Crime", "Thriller", "Mystery"], yearRange: "2017-2021", seasons: 4, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Tunnel", genre: ["Crime", "Mystery", "Fantasy"], yearRange: "2017", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Save Me", genre: ["Thriller", "Mystery", "Drama"], yearRange: "2017", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Taxi Driver", genre: ["Action", "Crime", "Thriller"], yearRange: "2021-2023", seasons: 2, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Weak Hero Class 1", genre: ["Action", "Drama", "Thriller"], yearRange: "2022", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Because This Is My First Life", genre: ["Romance", "Comedy", "Drama"], yearRange: "2017", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Hometown Cha-Cha-Cha", genre: ["Romance", "Comedy", "Drama"], yearRange: "2021", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "When the Camellia Blooms", genre: ["Romance", "Comedy", "Mystery"], yearRange: "2019", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Chicago Typewriter", genre: ["Fantasy", "Romance", "Drama"], yearRange: "2017", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Flower of Evil", genre: ["Crime", "Mystery", "Romance"], yearRange: "2020", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Twenty-Five Twenty-One", genre: ["Romance", "Drama"], yearRange: "2022", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Our Blues", genre: ["Drama", "Romance"], yearRange: "2022", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "My Liberation Notes", genre: ["Drama", "Romance"], yearRange: "2022", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Beyond Evil", genre: ["Crime", "Thriller", "Mystery"], yearRange: "2021", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Mr. Sunshine", genre: ["Historical", "Romance", "Drama"], yearRange: "2018", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Extraordinary Attorney Woo", genre: ["Legal", "Drama", "Comedy"], yearRange: "2022", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "D.P.", genre: ["Action", "Crime", "Drama"], yearRange: "2021-2023", seasons: 2, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Move to Heaven", genre: ["Drama"], yearRange: "2021", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "It's Okay to Not Be Okay", genre: ["Romance", "Drama", "Comedy"], yearRange: "2020", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Hospital Playlist", genre: ["Drama", "Comedy", "Medical"], yearRange: "2020-2021", seasons: 2, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Stranger", genre: ["Crime", "Drama", "Mystery"], yearRange: "2017-2020", seasons: 2, language: "Korean", platform: "Netflix", status: "Watched" },
    { name: "Signal", genre: ["Crime", "Drama", "Fantasy"], yearRange: "2016", seasons: 1, language: "Korean", platform: "Netflix", status: "Watched" },
  ...
  Spanish: [
    ...
    { name: "Dark Desire", genre: ["Thriller", "Drama"], yearRange: "2020-2022", language: "Spanish", seasons: 2, platform: "Netflix", status: "Watching" },
    { name: "Who Killed Sara?", genre: ["Mystery", "Thriller"], yearRange: "2021-2022", language: "Spanish", seasons: 3, platform: "Netflix", status: "Watched" },
    { name: "Control Z", genre: ["Drama", "Thriller"], yearRange: "2020-2022", language: "Spanish", seasons: 3, platform: "Netflix", status: "Planned" },
    { name: "Narcos: Mexico", genre: ["Crime", "Drama"], yearRange: "2018-2021", language: "Spanish", seasons: 3, platform: "Netflix", status: "Watched" },
  ],
  Tamil: [
  ...
  Chinese: [
    { name: "When I Fly Towards You", genre: ["Romance", "Comedy", "Drama"], yearRange: "2023", seasons: 1, language: "Chinese", platform: "Netflix", status: "Watched" },
    { name: "Hidden Love", genre: ["Romance", "Comedy", "Drama"], yearRange: "2023", seasons: 1, language: "Chinese", platform: "Netflix", status: "Watched" },
    { name: "The First Frost", genre: ["Romance", "Drama"], yearRange: "2025", seasons: 1, language: "Chinese", platform: "Netflix", status: "Watched" },
  ],
};
